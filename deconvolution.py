#!/usr/bin/env python
'''
Code from https://github.com/opencv/opencv/blob/master/samples/python/deconvolution.py
...
Usage:
  ...
  Keys:
    ...
    ESC   - exit
Examples:
  deconvolution.py --angle 135 --d 22  test_images/opencv_samples_data/licenseplate_motion.jpg
    (image source: http://www.topazlabs.com/infocus/_images/licenseplate_compare.jpg)
  deconvolution.py --angle 86 --d 31  test_images/opencv_samples_data/text_motion.jpg
  deconvolution.py --circle --d 19  test_images/opencv_samples_data/text_defocus.jpg
...
if __name__ == '__main__':
    ...
    try:
        ...
        fn = 'test_images/opencv_samples_data/licenseplate_motion.jpg'
    win = 'deconvolution'
    img = cv2.imread(fn, 0)
    if img is None:
